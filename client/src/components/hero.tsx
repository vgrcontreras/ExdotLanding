...
export function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-start pt-32 overflow-hidden bg-background">
      {/* Background Image with Overlay (Dark Mode Only) */}
      <div className="absolute inset-0 z-0 mt-20 md:mt-0 hidden dark:block">
      ...
      <div className="absolute inset-0 z-0 mt-20 md:mt-0 dark:hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-purple-100 via-background to-background opacity-80" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-purple-600 dark:from-white dark:via-purple-200 dark:to-white/50">
          ...
          >
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 h-12 rounded-full text-base font-semibold shadow-[0_0_20px_rgba(139,92,246,0.3)] transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(139,92,246,0.4)]">
              Comece Agora
