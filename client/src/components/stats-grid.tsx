  ...
  return (
    <section className="py-32 bg-background relative overflow-hidden" id="sobre">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Glowing Orb Centerpiece (Dark Mode) */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] opacity-40 pointer-events-none dark:block hidden">
           <img src={orbImage} alt="" className="w-full h-full object-contain animate-pulse-slow" />
        </div>

        {/* Light Mode Accent */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-purple-100/50 blur-[120px] rounded-full -z-10 dark:hidden" />
